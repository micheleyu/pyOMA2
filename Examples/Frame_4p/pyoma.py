...
fig11 = frame_4P.plot_geo2(scaleF=0.1)
...
# or directly
frame_4P.mpe("FSDD", sel_freq=[4 , 5 , 6 , 6.9, 7], MAClim=0.95)
...
frame_4P.plot_mode_geo2(algo_res=fsdd.result, mode_nr=1, view="3D", scaleF=5)
frame_4P.plot_mode_geo2(algo_res=fsdd.result, mode_nr=2, view="3D", scaleF=5)
frame_4P.plot_mode_geo2(algo_res=fsdd.result, mode_nr=3, view="3D", scaleF=5)
frame_4P.plot_mode_geo2(algo_res=fsdd.result, mode_nr=4, view="3D", scaleF=5)
